...
Those with **only primary education or below are roughly neutral for most of their working lives**. Even during prime working ages, their average net fiscal contribution is slightly below zero. As a result, their synthetic lifetime fiscal contribution is substantially negative.
